...
class ReleaseTask {
  ...
  */
  async release() {
    ...
    console.log(`Linking dataset to task...`);
    await linkTaskToDataset(this.uri, dataset.uri);
  };
...
async function linkTaskToDataset(taskUri, datasetUri) {
   ...
   * @public
  */
  // TODO this function is not yet used - how to make sure the task is marked as failed when something goed wrong?
